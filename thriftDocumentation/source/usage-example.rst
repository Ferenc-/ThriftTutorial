...
* Let's create first the .thrift definition of our service. The .thrift file I am going to use is the same you saw in the :doc:`thrift-file` and is as shown below: ::
